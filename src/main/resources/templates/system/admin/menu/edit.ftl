		...
		<form id="securityEditForm">
			...
			<div class="box-body">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="username" id="username" value="${bean.username!}" disabled placeholder="输入账号...">
				</div>
				<div class="form-group">
					<label id="nickNameLabel">昵称</label>
					<input type="text" class="form-control" name="name" id="name" value="${bean.name!}" placeholder="输入昵称...">
				</div>
				<div class="form-group">
					<label>性别</label>
						...
						<#if bean.role??>
							<#if role.value == 'super'>
								<@shiro.hasPermission name="super:update">
									<label>
					                  <input type="radio" name="roleId" class="flat-red" value="${role.id}" <#if bean.role.value == role.value>checked</#if>> ${role.name}
					                </label>
				                </@shiro.hasPermission>
			                <#else>
			                	<label>
